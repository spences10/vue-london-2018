...
<Head>
  ...
  <link rel="shortcut icon" href={require("file-loader!./static/favicon.png")}/>
</Head>
...
<img src={require("file-loader!./images/labradoodle-or-fried-chicken.png")}/>
...
<img height="800px" src={require("file-loader!./images/vue-logo.png")}/>
...
<Appear>
  <div><h2>a UI</h2></div>
  <div><h3>(Grapical) User Interface</h3></div>
  <div><h2>for a CLI</h2></div>
  <div><h3>Command Line Interface</h3></div>
</Appear>
